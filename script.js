...
// var apiResponses = fetchData();
var apiResponses = // your json data


function mapApiResponseToDataObject(apiResponse) {
    // Initialize an array to store categories
  
    // Map the response array to a new array of objects
  ...
  var dataObjects = mapApiResponseToDataObject(apiResponses[0]);
